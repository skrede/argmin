#ifndef HPP_GUARD_NABLAPP_DERIVATIVE_FINITE_DIFFERENCE_H
#define HPP_GUARD_NABLAPP_DERIVATIVE_FINITE_DIFFERENCE_H
                 ...
                 Eigen::VectorX<Scalar>& g)
{
    ...
    Eigen::VectorX<Scalar> x_perturbed = x;
...
// The VectorFunction interface is: void f(const VectorX<S>& x, VectorX<S>& out).
...
template <typename VectorFunction, typename Scalar = double>
