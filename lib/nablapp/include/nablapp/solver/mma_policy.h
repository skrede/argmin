...
#include "nablapp/detail/ccsa_dual_problem.h"
...
struct mma_policy
{
    ...
    step_result<double> step(state_type<P>& s)
    {
        ...
        // Constraint sign convention: nablapp c_ineq >= 0 feasible,
        ...
        //
        // The m-dimensional Lagrange dual is solved by an intra-nablapp
        ...
        //    Dual multipliers y_dual map directly to nablapp mu_ineq
