#ifndef HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_ISRES_RUNARSSON_YAO_PAPER_POLICY_H
#define HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_ISRES_RUNARSSON_YAO_PAPER_POLICY_H
