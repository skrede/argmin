#ifndef HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_ISRES_ORIGINAL_NABLAPP_POLICY_H
#define HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_ISRES_ORIGINAL_NABLAPP_POLICY_H
...
struct original_nablapp_policy
{
    using scalar_type = double;

    template <int M>
    using rebind = original_nablapp_policy<M>;
