#ifndef HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_GCMMA_RAA_AUGMENTED_POLICY_H
#define HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_GCMMA_RAA_AUGMENTED_POLICY_H
...
#include "nablapp/detail/mma_raa_augmented_dual_problem.h"
