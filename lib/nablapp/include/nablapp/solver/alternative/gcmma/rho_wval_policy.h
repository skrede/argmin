#ifndef HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_GCMMA_RHO_WVAL_POLICY_H
#define HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_GCMMA_RHO_WVAL_POLICY_H
...
#include "nablapp/detail/mma_augmented_dual_problem.h"
