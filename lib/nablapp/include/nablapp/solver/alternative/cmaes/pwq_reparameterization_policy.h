#ifndef HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_CMAES_PWQ_REPARAMETERIZATION_POLICY_H
#define HPP_GUARD_NABLAPP_SOLVER_ALTERNATIVE_CMAES_PWQ_REPARAMETERIZATION_POLICY_H
