#ifndef HPP_GUARD_NABLAPP_DETAIL_CCSA_DUAL_PROBLEM_H
#define HPP_GUARD_NABLAPP_DETAIL_CCSA_DUAL_PROBLEM_H
...
// subproblem as a nablapp problem type satisfying differentiable and
// bound_constrained. Any nablapp box-constrained policy (lbfgsb,
