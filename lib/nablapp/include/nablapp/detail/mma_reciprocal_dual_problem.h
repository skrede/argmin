#ifndef HPP_GUARD_NABLAPP_DETAIL_MMA_RECIPROCAL_DUAL_PROBLEM_H
#define HPP_GUARD_NABLAPP_DETAIL_MMA_RECIPROCAL_DUAL_PROBLEM_H
...
// as a nablapp problem type satisfying differentiable + bound_constrained.
// Any nablapp box-constrained policy (lbfgsb, byrd_lbfgsb, bobyqa) can
// solve it.
//
...
// the value() (since nablapp policies minimize). By the envelope theorem,
