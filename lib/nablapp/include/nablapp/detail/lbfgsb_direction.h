#ifndef HPP_GUARD_NABLAPP_DETAIL_LBFGSB_DIRECTION_H
#define HPP_GUARD_NABLAPP_DETAIL_LBFGSB_DIRECTION_H
...
template <typename Problem, typename Scalar = double, int N = nablapp::dynamic_dimension>
