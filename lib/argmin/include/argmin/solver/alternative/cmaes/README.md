...
The variant ranking above is reproducible from the persistent comparison harness at `benchmarks/micro_cmaes.cpp`, which re-runs the boundary-handling A/B on any commit.
