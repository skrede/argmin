#ifndef HPP_GUARD_ARGMIN_DETAIL_KRAFT_LSQ_QP_RECOVERY_H
#define HPP_GUARD_ARGMIN_DETAIL_KRAFT_LSQ_QP_RECOVERY_H
...
// passed to the QP. argmin's outer SQP convention sets b = -c (constraint
