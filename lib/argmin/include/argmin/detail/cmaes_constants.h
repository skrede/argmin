#ifndef HPP_GUARD_ARGMIN_DETAIL_CMAES_CONSTANTS_H
#define HPP_GUARD_ARGMIN_DETAIL_CMAES_CONSTANTS_H
...
template <typename Scalar = double, int Lambda = argmin::dynamic_dimension>
struct cmaes_params
{
    int lambda;
    int mu;
