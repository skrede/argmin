#ifndef HPP_GUARD_ARGMIN_DETAIL_ALTERNATIVE_CMAES_SAMPLING_ZIGGURAT_H
#define HPP_GUARD_ARGMIN_DETAIL_ALTERNATIVE_CMAES_SAMPLING_ZIGGURAT_H
...
namespace argmin::detail::alternative::ziggurat
{
