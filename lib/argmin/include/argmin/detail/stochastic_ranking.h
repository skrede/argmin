#ifndef HPP_GUARD_ARGMIN_DETAIL_STOCHASTIC_RANKING_H
#define HPP_GUARD_ARGMIN_DETAIL_STOCHASTIC_RANKING_H
...
template <typename Scalar = double, int Lambda = argmin::dynamic_dimension, typename Rng>
