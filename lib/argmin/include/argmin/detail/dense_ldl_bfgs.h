#ifndef HPP_GUARD_ARGMIN_DETAIL_DENSE_LDL_BFGS_H
#define HPP_GUARD_ARGMIN_DETAIL_DENSE_LDL_BFGS_H
...
{
public:
    explicit dense_ldl_bfgs(int n = (N == argmin::dynamic_dimension ? 0 : N))
        : n_(n)
