#ifndef HPP_GUARD_ARGMIN_DETAIL_PROJECTED_GN_STEP_H
#define HPP_GUARD_ARGMIN_DETAIL_PROJECTED_GN_STEP_H
...
// In argmin convention g = J^T r is the gradient of 0.5*||r||^2:
