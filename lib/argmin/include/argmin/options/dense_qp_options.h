#ifndef HPP_GUARD_ARGMIN_OPTIONS_DENSE_QP_OPTIONS_H
#define HPP_GUARD_ARGMIN_OPTIONS_DENSE_QP_OPTIONS_H
...
// Tuning knobs for the dense operator-splitting QP solver.
//
