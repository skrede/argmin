...
TEST_CASE("basic_solver_group construction", "[solver_group]")
{
    ...
    {
        basic_solver_group<round_robin_schedule, nablapp::dynamic_dimension, void, test::mock_policy, test::mock_policy>
            group{prob, x0, opts};
        (void)group;
...
TEST_CASE("basic_solver_group fold expression concept check", "[solver_group]")
{
    ...
    basic_solver_group<round_robin_schedule, nablapp::dynamic_dimension, void, test::mock_policy, test::non_converging_policy>
        group{prob, x0};
    (void)group;
